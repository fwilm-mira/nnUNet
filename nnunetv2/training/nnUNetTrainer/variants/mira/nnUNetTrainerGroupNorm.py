...
class TransposedGroupNorm(GroupNorm):
    def __init__(self, num_channels, **norm_op_kwargs):
        super().__init__(num_groups = 8, num_channels = num_channels, **norm_op_kwargs)
    
class nnUNetTrainerGroupNorm(nnUNetTrainer):
